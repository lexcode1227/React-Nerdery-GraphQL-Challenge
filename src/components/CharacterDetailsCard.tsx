...
const CharacterDetailsCard = ({
  ...
  return (
    <article className="flex flex-col gap-8 items-start text-base w-full text-black p-4">
        ...
        <table className="w-full">
          <tbody>
            ...
            <tr className="border-b-2 border-[#828282]/10">
              ...
              <td className="pb-2 text-right font-bold">{character?.status}</td>
            </tr>
            <tr className="border-b-2 border-[#828282]/10">
            ...
            <tr className="border-b-2 border-[#828282]/10">
              ...
              <td className="pb-2 text-right font-bold">{character?.gender}</td>
            </tr>
            <tr className="border-b-2 border-[#828282]/10">
      ...
      <div className="w-full">
        <h3 className="pb-2 font-bold text-[#333333]">Episodes Information</h3>
        <table className="w-full">
          <tbody>
            {character?.episode.slice(0, 5).map((episode) => (
              ...
              >
                ...
                <td className="pb-2 text-right font-bold">{episode.episode}</td>
              </tr>
            ))}
          </tbody>
        </table>
